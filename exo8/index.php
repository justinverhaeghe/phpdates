...
$dateNow->sub(new DateInterval('P22D'));
...
<head>
    ...
    <title>PHP Dates - Exercice 8</title>
</head>
<!-- Header -->
...
<body>
    ...
    <main>
        ...
        <div class="text-center p-4">
            <p>Consigne : Afficher la date du jour - 22 jours</p>
        ...
        <div class="text-center ">
            ...
            <p>Il y a 22 jours, nous étions le : <?= $dateNow->format('d-m-Y') ?></p>
